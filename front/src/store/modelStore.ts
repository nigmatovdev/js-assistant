...
export const API_MODELS: ModelOption[] = [
  ...
  // { id: 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free', label: 'Nemotron 30B', desc: 'NVIDIA (Bepul)' },
  // { id: 'qwen/qwen3-next-80b-a3b-instruct:free', label: 'Qwen3 80B', desc: 'Qwen (Bepul)' },
  // { id: 'google/gemma-4-26b-a4b-it:free', label: 'Gemma 4 26B', desc: 'Google (Bepul)' },
];
